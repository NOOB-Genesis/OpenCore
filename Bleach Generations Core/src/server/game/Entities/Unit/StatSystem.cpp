...
void Player::UpdateAttackPowerAndDamage(bool ranged)
{
    ...
    else
    {
        switch (getClass())
        {
            // Genesis - Added Shinigami class with custom formula
            case CLASS_SHINIGAMI:
                val2 = level * 2.0f + (GetStat(STAT_STRENGTH) * (150 / 100)) + (GetStat(STAT_AGILITY) * (50 / 100)) - 20.0f;
                break;
            case CLASS_WARRIOR:
...
{
    0.9800f,  // Shinigami - Genesis - Added Shinigami crit diminishing k
    0.9560f,  // Warrior
    0.9560f,  // Paladin
    0.9880f,  // Hunter
    0.9880f,  // Rogue
...
float Player::GetMissPercentageFromDefence() const
{
    ...
    {
        16.00f,     // Shinigami - Genesis - Added Shinigami miss percentage
...
void Player::UpdateParryPercentage()
{
    ...
    {
        100.560408f,    // Shinigami - Genesis - Added Shinigami parry percentage
        47.003525f,     // Warrior
        47.003525f,     // Paladin
        145.560408f,    // Hunter
        145.560408f,    // Rogue
...
void Player::UpdateDodgePercentage()
{
    ...
    {
        145.129021f,    // Shinigami - Genesis - Added dodge chance
        88.129021f,     // Warrior
        88.129021f,     // Paladin
        145.560408f,    // Hunter
        145.560408f,    // Rogue
