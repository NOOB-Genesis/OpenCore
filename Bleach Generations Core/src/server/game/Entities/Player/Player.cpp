...
bool Player::BuildEnumData(PreparedQueryResult result, WorldPacket* data)
{
    ...
    *data << uint8(atLoginFlags & AT_LOGIN_FIRST ? 1 : 0);
    ...
    // Genesis - Possible future Bount and Zanpakuto implentation
...
void Player::GetDodgeFromAgility(float &diminishing, float &nondiminishing)
{
    ...
    {
         0.030000f, // Shinigami - Genesis - Pushed classes down; added Shinigami class
         0.036640f, // Warrior
         0.034943f, // Paladin
        -0.040873f, // Hunter
         0.020957f, // Rogue
    ...
    {
         1.50f/1.15f,    // Shinigami - Genesis - Pushed classes down; added Shinigami class
         0.85f/1.15f,    // Warrior
         1.00f/1.15f,    // Paladin
         1.11f/1.15f,    // Hunter
         2.00f/1.15f,    // Rogue
...
InventoryResult Player::CanRollForItemInLFG(ItemTemplate const* proto, WorldObject const* lootedObject) const
{
   ...
   // Used by group, function NeedBeforeGreed, to know if a prototype can be used by a player
    ...
    if (proto->Class == ITEM_CLASS_ARMOR && proto->SubClass > ITEM_SUBCLASS_ARMOR_MISC && proto->SubClass < ITEM_SUBCLASS_ARMOR_BUCKLER && proto->InventoryType != INVTYPE_CLOAK)
    {
        ...
        if (_class == CLASS_SHINIGAMI || _class == CLASS_MAGE || _class == CLASS_PRIEST || _class == CLASS_WARLOCK) // Genesis - Added Shinigami class to be able to roll for cloth items
