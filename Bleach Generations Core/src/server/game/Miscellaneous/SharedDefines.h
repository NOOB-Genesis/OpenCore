...
#define CLASSMASK_ALL_PLAYABLE \
    ((1<<(CLASS_SHINIGAMI-1))|(1<<(CLASS_WARRIOR-1))|(1<<(CLASS_PALADIN-1))|(1<<(CLASS_HUNTER-1))| \
    (1<<(CLASS_ROGUE-1))  |(1<<(CLASS_PRIEST-1)) |(1<<(CLASS_SHAMAN-1))| \
    (1<<(CLASS_MAGE-1))   |(1<<(CLASS_WARLOCK-1))|(1<<(CLASS_DRUID-1)) | \
    (1<<(CLASS_DEATH_KNIGHT-1)))
// Genesis - Added Shinigami class
...
enum QuestSort
{
    ...
    QUEST_SORT_SHINIGAMI           = 400 // Genesis - Added quest sort Shinigami
};
...
inline uint8 ClassByQuestSort(int32 QuestSort)
{
    switch (QuestSort)
    {
        ...
        case QUEST_SORT_SHINIGAMI:      return CLASS_SHINIGAMI; // Genesis - Added quest sort Shinigami
    }
    return 0;
}
...
enum SpellFamilyNames
{
    ...
    // 16 - unused
    SPELLFAMILY_PET         = 17,
    SPELLFAMILY_SHINIGAMI   = 18 // Genesis - Added Shinigami spell family
};
